      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-muted-foreground mb-8">
            Join thousands building businesses with AI-powered guidance.
          </p>
          ...
          <form onSubmit={handleRegister} className="mb-6">
            ...
            <div className="flex items-start space-x-2 mb-6">
              ...
              <label htmlFor="terms" className="text-sm text-muted-foreground">
                I agree to the{" "}
                <a href="#" className="text-[#8b6b4a] hover:underline font-medium">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="#" className="text-[#8b6b4a] hover:underline font-medium">
            ...
            <Button 
              type="submit"
              className="w-full h-12 bg-[#8b6b4a] hover:bg-[#7a5a3f] text-white rounded-lg font-semibold mb-6"
              disabled={isLoading}
            >
          ...
          <div className="text-center">
            ...
            <Link to="/signin" className="text-sm text-[#8b6b4a] hover:underline font-medium">
              Sign in
            </Link>
          </div>
        </div>
